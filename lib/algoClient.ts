...
const currentNetwork: 'testnet' | 'mainnet' =
  (process.env.NEXT_PUBLIC_ALGOD_NETWORK as 'testnet' | 'mainnet') || 'testnet'
...
export const algorandClient = AlgorandClient.fromClients({ algod, indexer, kmd })
